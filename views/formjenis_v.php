...
<html lang="en">
  ...
  <body>
  <div class="container">
  <form action="<?php echo base_url('Formjenis/input_data')?>" method="post">
  ...
  <div class="form-group">
    ...
    <input type="nm_jenis" class="form-control" id="nm_jenis" name="nm_jenis" placeholder="Masukan Nama">
  </div>
<div class="form-group">
    <label for="exampleInputEmail1">Tarif</label>
    <input type="tarif" class="form-control" id="tarif" name="tarif" placeholder="Masukan Jumlah Tarif">
  </div>
  <div class="form-group">

...
<html lang="en">
  ...
  <body>
  <div class="container">
  <form action="<?php echo base_url('Formkonsumen/input_data')?>" method="post">
  ...
  <div class="form-group">
    ...
    <input type="nm_konsumen" class="form-control" id="nm_konsumen" name="nm_konsumen" placeholder="Masukan Nama">
  </div>
<div class="form-group">

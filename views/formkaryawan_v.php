...
<html lang="en">
  ...
  <body>
  <div class="container">
  <form action="<?php echo base_url('Formkaryawan/input_data')?>" method="post">
  ...
  <div class="form-group">
    ...
    <input type="nm_karyawan" class="form-control" id="nm_karyawan" name="nm_karyawan" placeholder="Masukan Nama">
  </div>
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="jns_kelamin" class="form-control" id="jns_kelamin" name="jns_kelamin" placeholder="Masukan Jenis Kelamin">
  </div>
  <div class="form-group">
